error id: file:///C:/Users/Pitersoon/Desktop/Scala-final/poker-scala/app/model/Player.scala:scala/collection/immutable/List#map().
file:///C:/Users/Pitersoon/Desktop/Scala-final/poker-scala/app/model/Player.scala
...
non-local guesses:
	 ...
	 -cards/zipWithIndex/map#
	 -cards/zipWithIndex/map().
	 -scala/Predef.cards.zipWithIndex.map.
	 -scala/Predef.cards.zipWithIndex.map#
	 -scala/Predef.cards.zipWithIndex.map().
offset: 450
uri: file:///C:/Users/Pitersoon/Desktop/Scala-final/poker-scala/app/model/Player.scala
text:
```scala
package model
...
case class Hand(cards: List[Card]) {
  ...
  override def toString: String =
    cards.zipWithIndex.ma@@p { case (c) => s"$c" }.mkString("  ")
}
object Hand {
